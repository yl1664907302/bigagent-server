...
type SmpData struct {
	...
	Smpnet   map[string]*SmpInfo            `protobuf:"bytes,11,rep,name=Smpnet,proto3" json:"Smpnet,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (x *SmpData) GetSmpnet() map[string]*SmpInfo {
	if x != nil {
		return x.Smpnet
	}
	return nil
...
func (x *SmpInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SmpInfo) ProtoMessage() {}

func (x *SmpInfo) ProtoReflect() protoreflect.Message {
	mi := &file_server_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (*SmpInfo) Descriptor() ([]byte, []int) {
	return file_server_proto_rawDescGZIP(), []int{7}
}

func (x *SmpInfo) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
var file_server_proto_goTypes = []interface{}{
	...
	(*SmpInfo)(nil),               // 7: grpc_server.SmpInfo
